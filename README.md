...
1. Team Members: Mike Nichols
2. App Name: MortgageWatch
3. App Description (3-5 sentences):

    An app that tracks your mortgage balance and allows the homeowner to see benefits of refinancing or consider the affordability of purchasing a new home.
    
4. Your #1 Customer (Who would use your app? Why now?)
 
    Homeowners with a current mortgage
    
5. Github code repository: https://github.com/roadhousemike/MyMortgage`
6. Github Project/Trello Board: https://github.com/roadhousemike/MyMortgage
...
1. Save and access their current mortgage details
2. Compare a potential purchase to their current mortgage scenario (affordability-type comparison of payment v payment)
3. Compare a potential refinance to their current mortgage scenario (clinical comparison of key rate/equity impact on asset)
